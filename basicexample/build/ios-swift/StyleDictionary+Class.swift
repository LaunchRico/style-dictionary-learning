...
public class StyleDictionaryClass {
    ...
    public static let thisisthefirstelementThisisthesecondelementRojoRojito = #FF7F50
    public static let thisisthefirstelementThisisthesecondelementRojoRojo = #FF0000
}
